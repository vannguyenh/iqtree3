...
********************************************************/
	...
	*/
	void incoporateParams(double &scale, DoubleVector &tax_weight, Node *node = nullptr, Node* dad = nullptr);
	...
	*/
	void buildLeafMapName(LeafMapName &lsn, Node *node = nullptr, Node* dad = nullptr);

	int findNearestTaxon(Node* &taxon, Node *node, Node *dad = nullptr);
...
********************************************************/
	...
	*/
	...
	/**
		...
		@param dad dad of the node, used to direct the search
	*/
	void makeTaxaSet(set<string> &taxa_name, PDTaxaSet &taxa_set, Node *node = nullptr, Node *dad = nullptr);
	...
	*/
	bool calcPD(Split &id_set, double curlen = 0.0, Node *node = nullptr, Node *dad = nullptr);
